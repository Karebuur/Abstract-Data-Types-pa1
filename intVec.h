...
/** intVec.h
 * The purpose of the header file is to contain declarations and function
 prototypes that are to be used amongst multiple files. In this case, it makes
 it so that these functions and declarations work for intVec.c and graph01.c
 */
...
/** intTop()
 *
 * Preconditions: if intSize > 0;
 * Postcondition:
 *      Sets the return value to 0 if the sz = 0.
 *      Otherwise, the return value is the last value inserted into the vector.
 */
